...
var vegetables = ['cabbage','basil','lettuce', 'kale','radish'];
...
var fruits = ['avocado','banana','cherry', 'blueberry','mango', 'water melon', 'peach']
...
var groceryStore = {
    name: 'King Soopers',
    isOpen: true,
    servOption: ['Curb Pickup', 'Delivery', 'In-Store shopping'],
    phone: 3031234567,
    }
